#ifndef ATTENTION_AUX_PERCEPTION_NODES__DETECTION_3D_PROJECTOR_NO_DEPHT_HPP
#define ATTENTION_AUX_PERCEPTION_NODES__DETECTION_3D_PROJECTOR_NO_DEPHT_HPP
...
class Detection3dProjectorNoDepht : public rclcpp::Node
{

public:
  explicit Detection3dProjectorNoDepht(
    const std::string & node_name = "spatial_projector_no_depht_node");
  virtual ~Detection3dProjectorNoDepht() = default;
...
#endif  // ATTENTION_AUX_PERCEPTION_NODES__DETECTION_3D_PROJECTOR_NO_DEPHT_HPP
