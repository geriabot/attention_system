...
Detection3dProjectorNoDepht::Detection3dProjectorNoDepht(
  ...
  previous_marker_count_(0)
{
  ...
  cam_info_sub_ = this->create_subscription<sensor_msgs::msg::CameraInfo>(
    ...
    std::bind(&Detection3dProjectorNoDepht::camera_info_callback, this, std::placeholders::_1));

  RCLCPP_INFO(
    this->get_logger(),
    "Spatial Projector No Depht Node initialized. Waiting for CameraInfo...");
}

void
Detection3dProjectorNoDepht::camera_info_callback(
  const sensor_msgs::msg::CameraInfo::SharedPtr msg)
{
  if (!camera_info_received_) {
    ...
    det_sub_ = this->create_subscription<vision_msgs::msg::Detection2DArray>(
      "detections_2d", 10,
      std::bind(&Detection3dProjectorNoDepht::detections_callback, this, std::placeholders::_1));
  }
}

visualization_msgs::msg::Marker
Detection3dProjectorNoDepht::create_centroid_marker(
...
void
Detection3dProjectorNoDepht::detections_callback(
  const vision_msgs::msg::Detection2DArray::SharedPtr msg)
{
  ...
  for (const auto & det2d : msg->detections) {
    ...
    const double z_meters = 1.0 / std::sqrt(
